            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-md-8 p-3">
                        ...
                        <Card.Text ><b>Linkedin:</b> <a href={links.linkedin} className="text-dark" style={{textDecoration: "none"}}>Tenish Remish</a></Card.Text>
                        <Card.Text><b>Medium:</b> <a href={links.medium} className="text-dark" style={{textDecoration: "none"}}>Crunchyknuckles</a></Card.Text>
                        <Card.Text><b>Github:</b> <a href={links.github} className="text-dark" style={{textDecoration: "none"}}>Tenish14</a></Card.Text>
               ...
               <div className="row">
                   <div className="col-md-4 my-2">
                       <Card>
                           ...
                           <Card.Body>
                               <Card.Title><a href={links.medium1} className="text-dark" style={{textDecoration: "none"}}>13 Useful JavaScript Array Tips and Tricks You Should Know</a></Card.Title>
                   ...
                   <Card>
                        ...
                        <Card.Body>
                            <Card.Title><a href={links.medium2} className="text-dark" style={{textDecoration: "none"}}>10 Awesome JavaScript Libraries You Should Try Out in 2021</a></Card.Title>
                   ...
                   <Card>
                        ...
                        <Card.Body>
                            <Card.Title><a href={links.medium3} className="text-dark" style={{textDecoration: "none"}}>The top 11 productivity tips for Software Engineers</a></Card.Title>
               ...
               <div className="row">
                   <div className="col-md-4 my-2">
                       <Card>
                           ...
                           <Card.Body>
                               <Card.Title><a href={links.medium4} className="text-dark" style={{textDecoration: "none"}}>How to send emails from a form in React (EmailJS)</a></Card.Title>
                   ...
                   <Card>
                        ...
                        <Card.Body>
                            <Card.Title><a href={links.medium5} className="text-dark" style={{textDecoration: "none"}}>These NPM Tricks Will Make You a Pro</a></Card.Title>
                   ...
                   <Card>
                        ...
                        <Card.Body>
                            <Card.Title><a href={links.medium6} className="text-dark" style={{textDecoration: "none"}}>Create Executable from Python Script using Pyinstaller</a></Card.Title>
